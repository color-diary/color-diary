...
const ServiceModal = ({ onClose }: ServiceModalProps) => {
  ...
  return (
    <div className='flex flex-col px-5 w-full  md:w-744px-row'>
      <div className="flex flex-col gap-32px-col px-4 pt-4 pb-6 md:px-96px-row md:pt-36px-col md:pb-56px-col rounded-5xl bg-sign-up border-4 border-border-color ">
        <div className="flex flex-col items-end self-stretch gap-1">
          ...
          <h1 className="text-center self-stretch text-[16px] md:text-24px font-[700] mb-4 tracking-0.48px">문의하기</h1>
        </div>
        <Input
          type="email"
          state={emailState}
        ...
        <div className='flex flex-col gap-2'>
          <label htmlFor="" className='text-[16px] text-18px font-medium'>문의사항을 작성해주세요</label>
...
ex)일기의 날짜가 입력이 안돼요.`}
            className='w-full resize-none h-[135px] md:h-160px-row outline-none text-[14px] md:text-18px'
