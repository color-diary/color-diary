...
const LogInForm = () => {
  ...
  return (
    <div className="w-full flex items-center justify-center bg-[#fdfcfb]">
      <div className="w-[auto] min-w-[300px] lg:min-w-[744px] h-[630px] mt-[224px] mb-[226px] px-[96px] py-[72px] 
      bg-white rounded-[32px] border-4 border-[#e6d3bc] flex flex-col justify-center items-center gap-12 shadow-md">
      {/* <div className={cn(["w-[auto] min-w-[300px] lg:min-w-[744px] h-[630px] mt-[152px] px-[96px] py-[72px]",
        " bg-white rounded-[32px] border-4 border-[#e6d3bc] flex flex-col justify-center items-center gap-12 shadow-md"])}> */}
        ...
        <div className="w-full flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-[552px] h-[51px] px-4 py-3 bg-white rounded-lg border border-[#878787] text-xl text-[#878787] outline-none mb-[24px]"
                />
                {email && (
                  <button
                    onClick={clearEmail}
                    className="absolute right-[35px] top-1/2 transform -translate-y-1/2 text-[#CECECE] text-[30px]"
                  >
                    &times;
                  </button>
                )}
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-[552px] h-[51px] px-4 py-[24px] bg-white rounded-lg border border-[#878787] text-xl text-[#878787] leading-[27px]"
                />
                {password && (
                  <button
          ...
          <div className="flex justify-between items-center gap-[16px]">
            <Button size="half" icon={<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-2">
            ...
            <Button size="half" priority="secondary" icon={<svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-2">
