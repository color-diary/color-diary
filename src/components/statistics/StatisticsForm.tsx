...
const StatisticsForm = () => {
  ...
  return (
    <div className="md:bg-[#FBF8F4] rounded-5xl md:w-744px-row md:h-916px-col flex items-center flex-col md:mt-84px-col mt-[48px] m-auto bg-[#FEFDFB] border-0 md:border-4 border-[#E6D3BC]">
