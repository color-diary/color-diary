...
const Header = () => {
    ...
    return (
        <div className='relative flex justify-right lg:justify-center items-center py-[8px] w-full min-h-[72px] border-b-[1px] shadow-sm'>
            ...
            <div className='absolute right-0 flex items-center space-x-4 mr-[31px]'>
                ...
                {!isLogin ? 
                (
                    <Link href={"/log-in"} onClick={handleClick}>
                    <Button onClick={handleClick} icon={<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    </svg>} href={"/log-in"} priority="secondary" size="lg">로그인</Button>
                    </Link>
                ) : 
                (
