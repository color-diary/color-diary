...
const terms: JSX.Element = (
  <div className="text-font-color text-12px-m md:text-14px font-normal tracking-0.24px md:tracking-0.28px">
    <div className="text-16px-m md:text-16px font-bold">제 1장 총직</div>
    <br />
    <div className="font-bold">제 1조 (목적)</div>
    {splitCommentWithSlash(
      '본 약관은 Color Inside 서비스(이하 "서비스")의 이용과 관련하여 회사와 이용자 간의 권리와 의무, 책임사항, 서비스 이용조건 및 절차 등을 규정함을 목적으로 합니다.'
    ).map((line, index) => (
    ...
    <br />
    <div className="font-bold text-16px">제 2 장 비회원 이용약관</div>
    <br />
    ...
    <br />
    <div className="font-bold text-16px">제 3 장 회원 이용약관</div>
    <br />
    ...
    <br />
    <div className="text-16px font-bold">제 4 장 기타</div>
    <br />
