...
const Header = () => {
    ...
    return (
        <div className="fixed top-0 w-full z-10 flex justify-between items-center h-[72px] border-b-[1px] border-[#FBF8F4] bg-white shadow px-[30px]">
            ...
            <div className="flex-1 flex justify-end items-center space-x-4 w-[141px]">
                ...
                {!isLogin ? (
                    <Button onClick={handleClick} href={"/log-in"} priority="secondary" size="lg" icon={
