...
const Header = () => {
  ...
  return (
    <div className="flex justify-between items-center p-4 h-[72px] border-b-4">
      ...
      <Link href={'/'}>
        <Image src="/logo.png" alt="logo Image" width={200} height={200} className="cursor-pointer" />
      </Link>
      <div className="flex space-x-4 flex-1 justify-end">
        <button onClick={toggleMusic}>{isPlaying ? <GiSoundOn size={24} /> : <GiSoundOff size={24} />}</button>
