  ...
  theme: {
    ...
    extend: {
      ...
      spacing: {
        ...
        '216px-row': 'calc(100vw * 0.11253)',
        '230px-row': 'calc(100vw * 0.11963)',
        '240px-row': 'calc(100vw * 0.125)',
        '250px-row': 'calc(100vw * 0.13025)',
        '272px-row': 'calc(100vw * 0.141667)',
        '280px-row': 'calc(100vw * 0.1458)',
        ...
        '38px-row-m': 'calc(100vw * 0.101333)',
        '40px-row-m': 'calc(100vw * 0.106667)',
        '48px-row-m': 'calc(100vw * 0.128)',
        '58px-row-m': 'calc(100vw * 0.154667)',
        ...
        '168px-row-m': 'calc(100vw * 0.448)',
        '173px-row-m': 'calc(100vw * 0.461333)',
        '196px-row-m': 'calc(100vw * 0.5227)',
        '200px-row-m': 'calc(100vw * 0.533)',
        '252px-row-m': 'calc((252 / 375) * 100vw)',
        '284px-row-m': 'calc(100vw * 0.7589)',
        ...
        '18px-col-m': 'calc(100vh * 0.016667)',
        ...
        'h-screen-custom': 'calc(100vh - 7rem)'
      },
      gap: {
