      ...
      <div className="grid md:grid-cols-4 grid-cols-2 gap-[16px] md:gap-x-24px-row md:gap-y-24px-col gap-x-3 gap-y-4">
          ...
          diaryList.map((diary) => {
            return (
              <div
                ...
                className="border md:border-2 border-[#E6D3BC] md:rounded-3xl rounded-xl overflow-hidden cursor-pointer w-[160px] md:w-176px-row md:min-w-[110px] "
        ...
        {isNeedNew && (
          <div
            ...
            className="border md:border-2 border-[#E6D3BC] md:rounded-3xl rounded-xl overflow-hidden cursor-pointer bg-white shadow-[0_0_5px_0_#F1A027] w-[160px] md:w-176px-row md:min-w-[110px]"
          >
            ...
            <div className="flex justify-center items-center pt-[4px] pb-[12px] h-64px-col">
